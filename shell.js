 ...
 * External Shell (Loads All Modules)
 * ════════════════════════════════════════════ */
...
// RENDER HOME
function renderHome() {    const categories = {
            ...
            <main style="padding:16px;padding-bottom:140px;">
                ...
                <div class="glass-card" style="margin-bottom:16px;overflow:hidden;">
                    ...
                    <div style="display:flex;justify-content:center;gap:8px;margin-top:16px;">
                        ${ANNOUNCEMENTS.map((_,i) => `<button onclick="goToSlide(${i})" style="width:10px;height:10px;border-radius:50%;border:none;background:${i===0?'var(--color-primary)':'var(--text-subtle)'};cursor:pointer;"></button>`).join('')}
                    </div>
                </div>
                ...
                <div class="neural-status">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
                        ...
                        </h3>                        <span style="color:var(--color-primary);font-size:10px;">SECURE</span>
                    </div>
        ...
        if (ghostTaps === 5) {
            ...
            setTimeout(() => {
                ...
                if (code === 'dreamos2026') {
                    ...
                    setTimeout(() => loadModule('ghost'), 500);
                } else if (code !== null) {
