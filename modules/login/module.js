        ...
        <div style="min-height: 80vh; display: flex; align-items: center; justify-content: center; padding: 1rem;">
            ...
            ">
                ...
                ">
                    ...
                    • Username: admin<br/>
                    • Role: Developer/Admin/Architect<br/>                    • Password: (any for demo)
                </div>
...
// Auto-restore user on load
(function() {    const savedUser = sessionStorage.getItem('dreamos-user');
    if (savedUser && window.DREAM) {
        window.DREAM.state.user = JSON.parse(savedUser);
        console.log('[AUTH] User restored:', window.DREAM.state.user.name);
    }
})();
