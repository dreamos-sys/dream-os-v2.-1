...
export const ThemeManager = {
    themes: {
        ...
        'light-minimal': {
            ...
            colors: {
                ...
                '--glass-shadow': '0 4px 24px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.5)',
                '--card-bg': 'rgba(255, 255, 255, 0.8)',                '--shadow': '0 4px 24px rgba(0, 0, 0, 0.08)'
            }
        },
        'cyberpunk': {
            name: '🤖 Cyberpunk',
    ...
    async set(themeName) {
        ...
        // Log to GhostArchitect        if (window.GhostArchitect) {
