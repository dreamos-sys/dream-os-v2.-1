...
export default function DashboardTV() {
  ...
  const modules = [
    { id: 1, name: "Command", path: "/modules/command", color: "from-emerald-500 to-teal-600", icon: "🎛️" },
    { id: 2, name: "Security", path: "/modules/security", color: "from-red-500 to-rose-600", icon: "🛡️" },
    { id: 3, name: "Booking", path: "/modules/booking", color: "from-blue-500 to-indigo-600", icon: "📅" },
    { id: 4, name: "K3", path: "/modules/k3", color: "from-amber-500 to-orange-600", icon: "⚠️" },
    ...
    { id: 12, name: "Settings", path: "/settings", color: "from-gray-500 to-slate-600", icon: "⚙️" },
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-4 md:p-8">
      <header className="text-center mb-8">
        <h1 className="text-3xl font-bold text-emerald-400">🎛️ Dream OS TV</h1>
